...
namespace cdr_labeler {
    ...
    void CDRLabelingWriter::OutputFilteringInfo() const {
        // todo: remove duplication with VJ Finder
        std::ofstream out(output_config_.filtering_info);
        ...
        out.close();
        INFO("Information about filtered reads was written to " << output_config_.filtering_info);
    }
}
